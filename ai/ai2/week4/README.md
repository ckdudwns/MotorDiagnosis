...
PR19에 반영된 자산별 lifecycle 연결과 측정 시각 기반 지속시간 처리를 재사용하고,
이벤트 상세·필터/페이지·검수/개별 메모·차트·CSV/XLSX 내보내기·권한별 운영 관리 화면을
기존 API에 연결했다. AI2-01/02와 UI-01~06의 구현 범위, API 경계 및 검사 방법은
[AI2 운영 대시보드 연결](../../../docs/ai2-dashboard-integration.md)에 정리했다.
